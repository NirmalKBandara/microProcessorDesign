...
HD_PWD='E:/Vivado project/Instruction_Decoder/Instruction_Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InstructionDecoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InstructionDecoder.tcl
