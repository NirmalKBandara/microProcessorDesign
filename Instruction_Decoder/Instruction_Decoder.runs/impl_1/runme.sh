...
HD_PWD='E:/Vivado project/Instruction_Decoder/Instruction_Decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InstructionDecoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source InstructionDecoder.tcl -notrace
